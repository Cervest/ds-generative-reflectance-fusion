...
Usage: evaluate_ESTARFM.py --root=<predicted_patch_directory> --target=<groundtruth_patch_directory>
...
def main(args):
    ...
    for patch_idx in os.listdir(root):
        ...
        for date in os.listdir(patch_directory):
            ...
            target_files_paths = [os.path.join(date_directory, band) for band in os.listdir(date_directory)]
            target_bands = load_in_multiband_raster(files_paths)
