"""
Runs loading of Sentinel-2 raw scenes, merge their bands into single raster
and reprojects them on same CRS

Usage: stack_and_reproject_s2.py --root=<raw_files_directory> --o=<output_directory> --scenes=<path_to_scenes_list>
...
def main(args):
    ...
    bands_reader = readers.S2BandReader(root=args['--root'])
    scene_writer = writers.S2SceneWriter(root=args['--o'])
